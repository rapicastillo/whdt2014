...
<head>
   <link rel='stylesheet' type='text/css' href='style/bootstrap.css'/>
    ...
    <link rel='stylesheet' type='text/css' href='css/whdt-mobile.css'/>
...
<div id="skrollr-body">
  <div class="container-fluid">
    ...
    <div class='row red-title' id='slide-2a-title'>
      <div class='col-sm-12 col-xs-12'>
        <h3>The context of humanitarian crises is changing</h3>
      </div>
    </div>
    ...
    <div class='row red-title' id='slide-3-title'>
      <div class='col-sm-12 col-xs-12'>
        <h3>people affected by <span class='highlight'>conflicts</span> and <span class='highlight'>natural disasters</span> in 2013</h3>
      </div>
    </div>
    ...
    <div class='row red-title'>
      <div class='col-sm-12'>
        <h3>Crises are longer and more expensive</h3>
      </div>
    </div>
...
<p class='white'>Due to the complexity of humanitarian crises, there are many gaps in the available information. Even the concepts of humanitarian needs and assistance are flexible, and there are also inherent biases in the information. To truly understand and measure impact, the humanitarian community will need to continue working on better standards and ways of collecting, sharing and using data.</p>
  ...
  $(function() {
     $('#slide-1-title').height(screen.height);
  });
  </script>
<script>
